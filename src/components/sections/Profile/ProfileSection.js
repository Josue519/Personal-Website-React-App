...
// Create a wrapper component for TypewriterText
const TypewriterTextWrapper = ({ isTyping, typingDuration, steps, children }) => {
  return (
    <TypewriterText
      $isTyping={isTyping}
...
// Update the TypewriterText styled component
const TypewriterText = styled.span`
  ...
  animation: ${({ $isTyping, $typingDuration, $steps }) => $isTyping ? css`
    ${typewriterAnimation} ${$typingDuration || '4s'} steps(${$steps || 50}, end),
      ...
      <HeroContainer>
        ...
        <ContentSection id="about-me">
          ...
          <ButtonsContainer>
            <PrimaryButton 
              as="a"
              href="/Josue_Marante_CV_2025.pdf" 
              target="_blank" 
              rel="noopener noreferrer"
              download="Josue_Marante_CV_2025.pdf"
              onClick={(e) => {
                // Add error handling for download
                e.preventDefault();
                const link = document.createElement('a');
                link.href = '/Josue_Marante_CV_2025.pdf';
                link.download = 'Josue_Marante_CV_2025.pdf';
            ...
            <SecondaryButton 
              as="a"
              href="mailto:marantefitness@gmail.com"
              onClick={(e) => {
                e.preventDefault();
                window.location.href = 'mailto:marantefitness@gmail.com';
              }}
            >
